...
const competitions = [
  { CompID: '1', CompName: 'Cuộc thi Koi 2024', Location: 'Hà Nội', StartDate: '2024-11-01', EndDate: '2024-11-03', Status: true },
  { CompID: '2', CompName: 'Cuộc thi Koi Quốc tế', Location: 'TP. HCM', StartDate: '2024-12-01', EndDate: '2024-12-05', Status: false },
  { CompID: '3', CompName: 'Cuộc thi Koi Nhật Bản', Location: 'Tokyo', StartDate: '2025-01-10', EndDate: '2025-01-12', Status: true },
];
            ...
            <TableBody>
              {competitions.map((comp) => (
                <TableRow key={comp.CompID}>
                  ...
                  <TableCell>{comp.Status ? 'Đang diễn ra' : 'Đã kết thúc'}</TableCell>
                  <TableCell>
