...
namespace KSM.APIService.Payment
{
    public class VNPayService : IVnPayService
    {
        ...
        public VNPayService(IConfiguration configuration, IVnPayService vpnPayService)
        {
            _configuration = configuration;
        }
        public string CreatePaymentUrl(TblregistrationPayment model, HttpContext context)
        {
